...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-md shadow-md">
    <h3 class="text-xl font-semibold text-gray-800 mb-4">Create New Coupon</h3>
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <div class="flex gap-2 items-center">
                    <input type="text" name="code" id="code" value="{{ old('code') }}"
                           class="flex-1 border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring focus:border-blue-400"
                    ...
                    <div class="flex items-center gap-1 mt-1">
                        ...
                        <label for="auto_generate" class="text-sm text-gray-600">Auto</label>
                    </div>
                </div>
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" name="discount_value" id="discount_value" value="{{ old('discount_value', 0) }}"
                       class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring focus:border-blue-400"
                       placeholder="10">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" step="0.01" min="0" name="min_order_amount" id="min_order_amount" value="{{ old('min_order_amount') }}"
                       class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring focus:border-blue-400"
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" name="discount_cap" id="discount_cap" value="{{ old('discount_cap') }}"
                       class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring focus:border-blue-400"
                       placeholder="Max discount amount">
                <p class="text-xs text-gray-400 mt-1">Only for percentage discounts</p>
            </div>
            ...
            <div>
                ...
                <input type="number" min="0" name="priority" id="priority" value="{{ old('priority', 0) }}"
                       class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring focus:border-blue-400">
                <p class="text-xs text-gray-400 mt-1">Higher = applied first</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" min="1" name="per_customer_limit" id="per_customer_limit" value="{{ old('per_customer_limit') }}"
                       class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring focus:border-blue-400"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Ctrl+click to select multiple. Leave empty for all categories.</p>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Ctrl+click to select multiple. Leave empty for all products.</p>
            </div>
        </div>
