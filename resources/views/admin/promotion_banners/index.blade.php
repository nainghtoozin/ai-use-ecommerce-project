...
@section('content')
<div x-data="promotionBannerDelete()" x-cloak>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <h3 class="text-xl font-semibold text-gray-800">Banner List</h3>
    ...
    <div class="mb-6">
    <form action="{{ route('admin.banners.search') }}" method="GET" class="flex flex-col sm:flex-row gap-3 sm:gap-2">
        <input
            type="text"
            name="query"
            value="{{ request('query') }}"
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="hover:bg-gray-200/30 transition">
                    ...
                    <td class="px-4 py-2 border-b text-center flex flex-col sm:flex-row justify-center gap-2">
                        <a href="{{ route('admin.banners.edit', $promotion->id) }}"
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center text-gray-500 py-4">No banners found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div x-show="show" x-transition.opacity
        ...
        <div @click.away="show = false" class="bg-white rounded-md shadow-lg p-6 w-96">
            ...
            <div class="flex justify-end gap-3">
                ...
                <form :action="`/admin/banners/${promotionId}`" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
...
<script>
function promotionBannerDelete() {
    return {
        show: false,
        promotionId: null,
        promotionName: '',
