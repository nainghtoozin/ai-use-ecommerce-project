        ...
        <table class="min-w-full text-left border-collapse">
            <thead class="bg-gray-100 text-gray-600 uppercase text-sm">
                <tr>
                    ...
                    <th class="px-4 py-3 border-b">QR</th>
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 border-b">
                        @if($method->qr_image)
                            <img src="{{ image_url($method->qr_image) }}" alt="{{ $method->name }} QR" class="w-10 h-10 rounded object-cover">
                        @else
                ...
                @empty
                <tr>
                    <td colspan="8" class="text-center text-gray-500 py-6">No payment methods found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
