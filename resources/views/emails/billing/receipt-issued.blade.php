...
<p style="margin:16px 0 0;">@if(!empty($receipt_url))<a href="{{ $receipt_url }}" style="display:inline-block;padding:10px 20px;background-color:#2563eb;color:#ffffff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:bold;">View Receipt</a> @endif@if(!empty($receipt_download_url))<a href="{{ $receipt_download_url }}" style="display:inline-block;padding:10px 20px;border:1px solid #cbd5e1;color:#334155;text-decoration:none;border-radius:8px;font-size:14px;font-weight:bold;">Download Receipt</a>@endif</p>
@endsection
