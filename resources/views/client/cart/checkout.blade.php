...
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="row g-4">
                <div class="col-lg-7">
                    ...
                    function recalculateTotal() {
                        ...
                        totalEl.textContent = (subtotal + currentDeliveryFee - discount).toLocaleString() + ' MMK';
                    }
                    </script>
                ...
                <div class="col-lg-5">
                    <div class="checkout-section order-summary sticky-top" style="top: 20px;">
                        ...
                        <div class="coupon-section mb-3 p-3 bg-light rounded">
                            <h6 class="fw-bold mb-2"><i class="bi bi-ticket-perforated me-2"></i>Have a coupon?</h6>
                            ...
                            <div id="appliedCouponInfo" style="display: none;" class="alert alert-success py-2 px-3 mb-0 small">
                                <i class="bi bi-check-circle me-1"></i>
                                <span id="appliedCouponText"></span>
                                <button type="button" class="btn-close btn-close-sm float-end" id="removeCouponBtn" aria-label="Remove"></button>
                            </div>
                        </div>
                        ...
                        <div class="order-calculations">
                            ...
                            <div class="calc-row" id="discountRow" style="display: none;">
                                ...
                                <span class="text-success" id="orderDiscount">-0 {{ $websiteInfo->currency ?? 'DT'}}</span>
                            </div>
                            <div class="calc-row">
                                <span>Shipping:</span>
    ...
    <script>
        ...
        const appliedCoupon = @json($appliedCoupon ?? null);
