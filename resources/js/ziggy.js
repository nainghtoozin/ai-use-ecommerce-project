const routes = {
    ...
    'storefront.customer.orders.invoice': '/store/{store_slug}/customer/orders/{invoice_number}/invoice',
    ...
    'storefront.customer.addresses.default': '/store/{store_slug}/customer/addresses/{address}/default',
