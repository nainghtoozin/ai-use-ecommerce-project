    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            <button
                ...
                className="w-full px-5 py-4 flex items-center justify-between hover:bg-gray-50 dark:bg-gray-950 transition-colors"
            >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className="px-2.5 py-1 rounded-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-xs text-gray-600 dark:text-gray-400 hover:border-violet-300 hover:text-violet-600 transition-colors"
                                    >
