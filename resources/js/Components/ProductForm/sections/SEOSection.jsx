...
export default function SEOSection({
    ...
    return (
        <div className="space-y-4">
            ...
            />
            <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">SEO Image</label>
                {previewUrl ? (
                    <div className="flex items-center gap-3">
                        <img
                            src={previewUrl}
                            alt="SEO preview"
                            className="w-24 h-24 rounded-lg object-cover border border-gray-200 dark:border-gray-800"
                        />
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-950 font-medium"
                        >
                            Choose Image
                        </button>
                        <span className="text-xs text-gray-400 dark:text-gray-500">JPG, PNG, WEBP (max 2MB)</span>
                    </div>
                )}
