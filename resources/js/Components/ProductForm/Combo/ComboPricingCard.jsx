    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Set your bundle selling price and view profitability</p>
            </div>
            ...
            <div className="p-5 space-y-5">
                <div className="max-w-xs">
                    ...
                    <input
                        ...
                        step="0.01"
                        min="0"
                        className="w-full rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
