        ...
        {website_info?.allow_registration !== false && (
            ...
            >
                {labels.register || 'Register'}
                            ...
                            <div className="hidden sm:flex items-center gap-2">
                                <Link href="/register" className="px-3 lg:px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors">
                                    Create Store
                                </Link>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            {storeSlug && website_info?.enable_wishlist !== false && (
                                <Link
                                    href="/wishlist"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:bg-gray-800"
                                >
