...
export default function StorefrontDesignTokens() {
    ...
    useEffect(() => {
        ...
        const values = {
            ...
            '--storefront-small-size': tokens.typography?.small_size,
            '--storefront-line-height': tokens.typography?.line_height,
            '--storefront-page-width': tokens.layout?.page_width,
            '--storefront-section-spacing': tokens.layout?.section_spacing || tokens.spacing?.section,
            '--storefront-content-spacing': tokens.layout?.content_spacing,
            ...
            '--storefront-spacing-card': tokens.spacing?.card,
            '--storefront-spacing-control': tokens.spacing?.control,
            ...
            '--storefront-border-width': tokens.borders?.width,
            '--storefront-border-style': tokens.borders?.style,
            ...
            '--storefront-input-style': tokens.inputs?.style,
