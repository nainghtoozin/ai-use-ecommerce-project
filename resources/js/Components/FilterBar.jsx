...
export default function FilterBar({
    ...
    const filterSummary = activeChips.length > 0
        ? activeChips.map(c => c.label).join(' · ')
        : null;

    return (
        <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm lg:sticky lg:top-16 lg:z-40">
                ...
                <div className="sm:hidden">
                    ...
                    <div className="flex items-center justify-between mt-3">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    {filterSummary && !mobileFiltersOpen && (
                    ...
                    {mobileFiltersOpen && (
                        <div className="mt-3 space-y-3 border-t border-gray-200 dark:border-gray-800 pt-3">
                            <div>
                                <label htmlFor="storefront-category-mobile" className="sr-only">Filter by category</label>
                                <select
                                    id="storefront-category-mobile"
                                    value={selectedCategory}
                                    onChange={(e) => onCategoryChange(e.target.value)}
                                    aria-label="Filter by category"
                                    className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 hover:bg-white dark:bg-gray-900 transition-colors"
                                >
                            ...
                            {brands && brands.length > 0 && (
                                <div>
                                    <label htmlFor="storefront-brand-mobile" className="sr-only">Filter by brand</label>
                                    <select
                                        id="storefront-brand-mobile"
                                        value={selectedBrand}
                            ...
                            <div>
                                <label htmlFor="storefront-type-mobile" className="sr-only">Filter by product type</label>
                                <select
                                    id="storefront-type-mobile"
                                    value={selectedType || ''}
                            ...
                            <div className="flex items-center gap-2">
                                <label htmlFor="storefront-min-price-mobile" className="sr-only">Minimum price</label>
                                <input
                                    id="storefront-min-price-mobile"
                                    type="number"
                                    value={localMinPrice}
                                    ...
                                    min="0"
                                    inputMode="numeric"
                                    className="w-24 px-3 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 hover:bg-white dark:bg-gray-900 transition-colors"
                                />
                                <span className="text-gray-400" aria-hidden="true">-</span>
                                <label htmlFor="storefront-max-price-mobile" className="sr-only">Maximum price</label>
                                <input
                                    id="storefront-max-price-mobile"
                                    type="number"
                                    value={localMaxPrice}
                            ...
                            <div className="flex items-center gap-4">
                                <label htmlFor="storefront-sort-mobile" className="sr-only">Sort products</label>
                                <select
                                    id="storefront-sort-mobile"
                                    value={sortBy}
                                    onChange={(e) => onSortChange(e.target.value)}
                                    aria-label="Sort products"
                                    className="flex-1 border border-gray-300 dark:border-gray-700 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 hover:bg-white dark:bg-gray-900 transition-colors"
                                >
