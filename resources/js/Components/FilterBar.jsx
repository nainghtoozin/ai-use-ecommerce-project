                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    <div className="relative flex-1">
                        <input
                            ...
                            className="w-full pl-10 pr-12 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 hover:bg-white dark:bg-gray-900 transition-colors text-sm"
                        />
                        ...
                        <div className="absolute right-2 top-1/2 -translate-y-1/2">
                            <button
                                ...
                                className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors relative"
                                tabIndex={-1}
                                type="button"
                            >
                    ...
                    <button
                        ...
                        className="lg:hidden flex items-center gap-2 px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-950 transition-colors"
                    >
