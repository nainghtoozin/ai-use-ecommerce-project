            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    {benefits.map((benefit) => (
                        <div
                            key={benefit.title}
                            className="group relative bg-gray-50 rounded-2xl p-6 sm:p-8 hover:bg-white dark:bg-gray-900 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-200 border border-transparent hover:border-gray-200 dark:border-gray-800"
                        >
