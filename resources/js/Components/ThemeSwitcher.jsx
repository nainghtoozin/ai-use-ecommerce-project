    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                title="Switch Theme"
            >
                {(() => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
                                    theme === t.code ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-700 dark:text-gray-300'
                                }`}
                            >
                                <Icon className="w-4 h-4" />
                                <span className="flex-1">{t.label}</span>
                                {theme === t.code && <Check className="w-4 h-4 text-blue-600 dark:text-blue-400" />}
                            </button>
                        );
                    })}
                </div>
