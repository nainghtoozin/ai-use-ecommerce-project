            ...
            return [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'Billing Payment Methods', href: '/superadmin/billing-payment-methods', icon: 'CreditCard' },
                    ]
                },
                {
                    title: 'Operations',
                    ...
                    <div className={`flex items-center ${collapsed ? 'justify-center' : ''}`}>
                        ...
                        {!collapsed && (
                            <div className="ml-3 flex-1 min-w-0">
                                ...
                                <p className="text-xs text-slate-500 truncate">{auth?.user?.role_label}</p>
                            </div>
                        )}
                    </div>
