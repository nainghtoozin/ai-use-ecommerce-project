...
export default function ShopLayout({ children, previewMode = null }) {
    ...
    return (
        <>
            ...
            <FlashMessages />
            <CartToast />
            <div className={`storefront-root ${isPreview && mode === 'mobile' ? 'max-w-[390px] mx-auto shadow-2xl' : ''} min-h-screen flex flex-col overflow-x-clip bg-gray-50 dark:bg-gray-950`}>
