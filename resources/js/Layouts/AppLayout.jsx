                        ...
                        >
                            ...
                            <div className="p-4 border-t border-gray-800">
                                ...
                                <div className="mt-3 flex gap-2">
                                    <Link href={adminUrl('/profile', storeSlug)} className="flex-1 text-center px-3 py-1.5 text-xs bg-gray-800 rounded hover:bg-gray-700 transition-colors">
                                        Profile
                                    </Link>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    {mobileMenuOpen && (
                                                        <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 z-50">
                                                            <Link href={adminUrl('/profile', storeSlug)} className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800">
                                                                Profile
                                                            </Link>
