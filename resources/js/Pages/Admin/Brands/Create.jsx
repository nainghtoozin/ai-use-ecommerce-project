...
export default function BrandCreate() {
    ...
    if (!auth?.user?.permissions?.includes('brands.create')) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(adminUrl('/admin/brands'), { preserveScroll: true });
    }
        ...
        <AdminLayout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Create Brand</h1>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-400">PNG, JPG, or WebP, max 2MB. Recommended: 200x200px.</p>
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-400">PNG, JPG, or WebP, max 5MB. Recommended: 800x400px.</p>
                        ...
                        <div>
                            ...
                            <input id="name" type="text" value={data.name} onChange={(e) => setData('name', e.target.value)}
                                className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. Nike" required />
                        ...
                        <div>
                            ...
                            <textarea id="description" value={data.description} onChange={(e) => setData('description', e.target.value)} rows={3}
                                className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Optional description" />
