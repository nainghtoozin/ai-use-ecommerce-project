        ...
        <AdminLayout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new brand for products</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">Leave empty to auto-generate from name.</p>
