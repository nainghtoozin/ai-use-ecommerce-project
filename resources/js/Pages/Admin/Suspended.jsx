        ...
        <AdminLayout>
            ...
            <div className="p-6 lg:p-8">
                <div className="max-w-2xl mx-auto text-center">
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-8 lg:p-12 shadow-sm">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-950 rounded-lg p-4 mb-8 text-left text-sm text-gray-600 dark:text-gray-400 space-y-2">
