    ...
    if (!auth?.user?.permissions?.includes('warehouses.update')) {
        return (
            <AdminLayout>
                ...
                <div className="py-12 text-center text-gray-500 dark:text-gray-400">You do not have permission to edit warehouses.</div>
            </AdminLayout>
        );
    }
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Edit Warehouse</h1>
