                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Warehouses</h1>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Manage your storage locations.</p>
                            </div>
                        </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                                    ...
                                    {warehouses.data?.map((warehouse) => (
                                        <tr key={warehouse.id} className="hover:bg-gray-50 dark:bg-gray-950">
                                                ...
                                                <div className="flex items-center justify-end gap-2">
                                                    {can('warehouses.update') && (
                                                        <Link
                                                            ...
                                                            className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                                                        >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <nav className="flex items-center gap-1">
                                        {warehouses.links.map((link, i) => {
                                            if (!link.url) {
                                                return <span key={i} className="px-3 py-1 text-sm text-gray-400 dark:text-gray-500 cursor-not-allowed" dangerouslySetInnerHTML={{ __html: link.label }} />;
                                            }
                                            return (
                                                <Link
                                                    key={i}
                                                    ...
                                                    preserveState
                                                    preserveScroll
                                                    className={`px-3 py-1 text-sm rounded-lg ${link.active ? 'bg-blue-600 text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800'}`}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setDeleteModal(null)}>
                    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6 w-full max-w-md mx-4" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Delete Warehouse</h3>
                        </div>
