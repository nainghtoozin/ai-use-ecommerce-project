...
export default function PromotionEdit({ promotion, products, categories }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        promotion_mode: (promotion.is_automatic || !promotion.code) ? 'automatic' : 'code',
    });
    ...
    function handleSubmit(e) {
        ...
        put(adminUrl(`/admin/promotions/${promotion.id}`));
    }
        ...
        <AdminLayout>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Edit Promotion</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Editing: <span className="font-medium">{promotion.name}</span></p>
                </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Cart subtotal must be at least this amount for the promotion to apply</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Maximum number of times this promotion can be used</p>
                                </div>
                                <div>
                                ...
                                <div className="flex flex-col justify-end gap-3">
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 dark:text-gray-500">Can be combined with other promotions</p>
                                        </div>
                                    </label>
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        <div className="relative">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 dark:text-gray-500">Promotion is live and can be used</p>
                                        </div>
                                    </label>
                                </div>
                            </div>
