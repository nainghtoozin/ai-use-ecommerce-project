        ...
        <AdminLayout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Create City</h1>
                </div>

                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">City Name</label>
                        ...
                        <div className="flex justify-end gap-3">
                            <Link href={adminUrl('/admin/cities')} className="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-gray-200">Cancel</Link>
