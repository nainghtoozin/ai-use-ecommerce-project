...
export default function CouponEdit({ coupon, products, categories }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        setData('code', data.code.toUpperCase());
        put(adminUrl(`/admin/coupons/${coupon.id}`));
    }
    ...
    return (
        <AdminLayout>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    <Link href={adminUrl('/admin/coupons')} className="text-sm text-blue-600 hover:underline">&larr; Back to Coupons</Link>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Edit Coupon</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Editing: <span className="font-medium">{coupon.name}</span></p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input id="name" type="text" value={data.name} onChange={e => setData('name', e.target.value)}
                                        className={inputClass('name')} placeholder="e.g. SUMMER20" required />
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                                <div>
                                    <label htmlFor="type" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                                ...
                                <div>
                                    <label htmlFor="value" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-gray-400 dark:text-gray-500 font-medium">{suffix}</span>
                                    </div>
                            ...
                            <div>
                                <label htmlFor="minimum_order_amount" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Minimum Order Amount</label>
                                ...
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Cart subtotal must be at least this amount for the coupon to apply</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            <div>
                                <label htmlFor="applies_to" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Applies To <span className="text-red-500">*</span></label>
                            ...
                            {data.applies_to === 'products' && (
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Select Products</label>
                                    <div className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
                                        <div className="p-2 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950">
                                            <div className="relative">
                                                <svg className="w-3.5 h-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                                        ...
                                        <div className="max-h-48 overflow-y-auto divide-y divide-gray-50">
                                            {filteredProducts.length === 0 ? (
                                                <p className="px-4 py-3 text-sm text-gray-400 dark:text-gray-500 text-center">No products found</p>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1.5">{data.product_ids.length} product(s) selected</p>
                                </div>
                            )}

                            {data.applies_to === 'categories' && (
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Select Categories</label>
                                    <div className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
                                        <div className="p-2 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950">
                                            <div className="relative">
                                                <svg className="w-3.5 h-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                                        ...
                                        <div className="max-h-48 overflow-y-auto divide-y divide-gray-50">
                                            {filteredCategories.length === 0 ? (
                                                <p className="px-4 py-3 text-sm text-gray-400 dark:text-gray-500 text-center">No categories found</p>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1.5">{data.category_ids.length} category(ies) selected</p>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Maximum number of times this coupon can be used</p>
                                </div>
                                <div>
                                    <label htmlFor="per_customer_limit" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Per-Customer Limit</label>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">How many times a single customer can use this</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-6 space-y-5">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Higher values are evaluated first.</p>
                                </div>
                                <div className="flex flex-col justify-end gap-3">
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        ...
                                        <div>
                                            <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Stackable</span>
                                            <p className="text-xs text-gray-400 dark:text-gray-500">Can be combined with other discounts</p>
                                        </div>
                                    </label>
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        <div className="relative">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 dark:text-gray-500">Coupon is live and can be used</p>
                                        </div>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <Link href={adminUrl('/admin/coupons')}
                            className="w-full sm:w-auto px-5 py-2.5 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 dark:bg-gray-950 transition-colors text-center">
                        ...
                        <button type="submit" disabled={processing}
                            ...
                            {processing ? (
                                ...
                                <span><svg className="w-4 h-4 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Update Coupon</span>
                            )}
                        </button>
                    </div>
                </form>
