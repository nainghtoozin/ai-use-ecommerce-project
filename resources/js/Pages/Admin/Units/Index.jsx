        ...
        <AdminLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <form onSubmit={handleSearch} className="flex gap-2 mb-6">
                    <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search units..." className="flex-1 border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                            {!units?.data?.length ? (
                                ...
                                <tr key={unit.id} className="hover:bg-gray-50 dark:bg-gray-950">
