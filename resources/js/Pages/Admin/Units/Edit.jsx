        ...
        <AdminLayout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Edit Unit</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update measurement unit details</p>
                </div>
