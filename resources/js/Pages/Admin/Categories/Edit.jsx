...
export default function CategoryEdit({ category, parentCategories }) {
    const { auth } = usePage().props;
    if (!auth?.user?.permissions?.includes('categories.update')) {
    ...
    const existingImage = category.image_url;
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(adminUrl(`/admin/categories/${category.id}`), {
            forceFormData: true,
            preserveScroll: true,
        });
    }
        ...
        <AdminLayout>
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Edit Category</h1>
                </div>
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-20 h-20 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 flex items-center justify-center overflow-hidden bg-gray-50 dark:bg-gray-950">
                                    {imagePreview ? (
                                        ...
                                        <img src={existingImage} alt={category.name} className="w-full h-full object-cover" />
                                    ) : (
