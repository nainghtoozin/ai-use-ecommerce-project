...
export default function CategoryEdit({ category }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        put(adminUrl(`/admin/categories/${category.id}`));
    }
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-3">
                            <Link href={adminUrl('/admin/categories')} className="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-gray-200">Cancel</Link>
