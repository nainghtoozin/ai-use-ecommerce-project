        ...
        <AdminLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <form onSubmit={handleSearch} className="flex gap-2 mb-6">
                    <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search categories..." className="flex-1 border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    <button type="submit" className="px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200">
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                            {!categories?.data?.length ? (
                                ...
                                <tr key={category.id} className="hover:bg-gray-50 dark:bg-gray-950">
