...
export default function RolesIndex({ roles, filters }) {
    ...
    return (
        <AdminLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Role Management</h2>}>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                                    ...
                                    <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
                                        {roles.data.map((role) => (
                                            <tr key={role.id} className="hover:bg-gray-50 dark:bg-gray-950">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="ml-3">
                                                            ...
                                                            <div className="text-xs text-gray-500 dark:text-gray-400">{role.guard_name}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{role.created_at}</td>
