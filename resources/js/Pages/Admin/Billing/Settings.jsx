            ...
            <div className="p-6 lg:p-8 space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure your billing preferences and payment methods</p>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-8 text-center">
                    ...
                    <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">Coming Next</h3>
