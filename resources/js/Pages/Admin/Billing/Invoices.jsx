            ...
            <div className="p-6 lg:p-8 space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">View and download subscription invoices</p>
                    </div>
                    <button
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                    ...
                    {data.length > 0 ? (
                        ...
                        <div className="p-8 text-center">
                            ...
                            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">No Invoices Yet</h3>
                            ...
                            {hasActiveFilters ? (
                                <button onClick={clearFilters} className="px-4 py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors">Clear Filters</button>
                            ) : (
