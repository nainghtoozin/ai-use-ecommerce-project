                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">Complete audit trail of all inventory changes.</p>
                        </div>
                    </div>
                        ...
                        {showFilters && (
                            <div className="p-4 bg-gray-50 dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800">
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                                    ...
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Inventory Location</label>
                                        <select
                                        ...
                                        return (
                                            <tr key={m.id} className="hover:bg-gray-50 dark:bg-gray-950">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    {m.product?.sku && <div className="text-xs text-gray-400 dark:text-gray-500 font-mono">{m.product.sku}</div>}
