                ...
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            <Link href={adminUrl('/admin/inventory/adjustments')} className="text-gray-400 hover:text-gray-600">
                                <ArrowLeft className="w-5 h-5" />
                            </Link>
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-900">New Stock Adjustment</h1>
                                <p className="text-sm text-gray-500">Correct stock levels by increasing or decreasing inventory.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        <div className="xl:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 p-6">
                                <h2 className="text-sm font-semibold text-gray-900 mb-4">Product</h2>
                                ...
                                <div className="relative" ref={searchRef}>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                                        />
                                    </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-gray-500 font-mono">{selectedProduct.sku || 'No SKU'}</div>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <div className="text-2xl font-bold text-gray-900">{Math.round(currentStock)}</div>
                            ...
                            {/* Adjustment Details */}
                            <div className="bg-white rounded-xl border border-gray-200 p-6">
                                <h2 className="text-sm font-semibold text-gray-900 mb-4">Adjustment</h2>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            min="0.01"
                                            step="0.01"
                                            className="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                                        />
                                ...
                                {/* Inventory Location */}
                                <div className="mb-4">
                                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Inventory Location</label>
                                    {hasMultipleLocations ? (
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-xs text-gray-500">Opening stock will be assigned to your primary store.</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                {currentStock !== null && parsedQuantity > 0 && (
                                    <div className="bg-gray-50 rounded-lg p-4 grid grid-cols-3 gap-4 text-center border border-gray-200">
                                        <div>
                                            <div className="text-xs text-gray-500 mb-1">Current</div>
                                            <div className="text-xl font-bold text-gray-900">{Math.round(currentStock)}</div>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xl font-bold text-gray-900">{Math.round(computedNewStock)}</div>
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            {/* Reason & Details */}
                            <div className="bg-white rounded-xl border border-gray-200 p-6">
                                <h2 className="text-sm font-semibold text-gray-900 mb-4">Reason & Details</h2>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {form.reason === REASON_OTHER && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1.5">Custom Reason <span className="text-red-500">*</span></label>
                                            <input
                                                type="text"
                        ...
                        <div className="xl:col-span-1">
                            <div className="sticky top-4 space-y-6">
                                <div className="bg-white rounded-xl border border-gray-200 p-6">
                                    <h2 className="text-sm font-semibold text-gray-900 mb-4">Adjustment Summary</h2>
                                    ...
                                    {!selectedProduct ? (
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                {selectedProduct.sku && <div className="text-xs text-gray-400 font-mono">{selectedProduct.sku}</div>}
                                            </div>
                                            ...
                                            {form.quantity && (
                                                <div className="border-t border-gray-100 pt-3">
                                                    ...
                                                    <div className="text-sm font-medium text-gray-900">{form.quantity} units</div>
                                                </div>
                                            )}

                                            <div className="border-t border-gray-100 pt-3">
                                                <div className="text-xs text-gray-500 mb-0.5">Location</div>
                                                <div className="text-sm font-medium text-gray-900">{defaultWarehouse?.name || 'Primary Store'}</div>
                                            </div>

                                            {currentStock !== null && parsedQuantity > 0 && (
                                                <div className="border-t border-gray-100 pt-3">
                                                    <div className="text-xs text-gray-500 mb-0.5">Stock Change</div>
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-sm text-gray-700">{Math.round(currentStock)}</span>
                                                        <span className="text-gray-400">→</span>
                                                        <span className="text-sm font-semibold text-gray-900">{Math.round(computedNewStock)}</span>
                                                    </div>
                                                </div>
                                            )}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Link
                                        ...
                                        className="w-full flex items-center justify-center px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
                                    >
                                        Cancel
                                    </Link>
                                </div>
                    ...
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 p-6">
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium text-gray-900">{form.quantity} units</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500">Location</span>
                                <span className="font-medium text-gray-900">{defaultWarehouse?.name || 'Primary Store'}</span>
                            </div>
                            {currentStock !== null && (
                                <div className="flex justify-between text-sm">
