                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Product-specific inventory history and timeline.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
                        <div className="relative" ref={searchRef}>
                            ...
                            {showDropdown && productSearch.length >= 2 && searchResults.length === 0 && !searching && (
                                <div className="absolute z-20 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg p-4 text-center text-sm text-gray-500">
                                    No products found
                                </div>
                            )}
                        </div>
                    ...
                    {!product && (
                        <div className="bg-white rounded-xl border border-gray-200 p-16 text-center">
                            ...
                            <h2 className="text-lg font-semibold text-gray-900 mb-2">Search a product to view its stock history</h2>
                        ...
                        <>
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
                                <div className="flex items-center justify-between flex-wrap gap-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <Link href={adminUrl(`/admin/inventory/product/${product.id}`)} className="text-lg font-semibold text-gray-900 hover:text-blue-600">
                                                {product.name}
                                            </Link>
                            ...
                            <div className="bg-white rounded-xl border border-gray-200">
                                <div className="px-6 py-4 border-b border-gray-100">
                                    <h2 className="text-sm font-semibold text-gray-900">Inventory Timeline</h2>
                                    <p className="text-xs text-gray-500 mt-0.5">{movements.length} record{movements.length !== 1 ? 's' : ''} — newest first</p>
                                </div>
                                ...
                                {movements.length === 0 ? (
                                    <div className="px-6 py-16 text-center text-gray-500">
                                        ...
                                        <p className="text-xs text-gray-400">Movements will appear here when inventory changes occur.</p>
                                    </div>
                                ) : (
