                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="flex-1">
                            <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Stock Movements</h1>
                            <p className="text-sm text-gray-500 dark:text-gray-400">History of all inventory changes.</p>
                        </div>
                    </div>
                        ...
                        <div className="p-4 border-b border-gray-200 dark:border-gray-800 space-y-3">
                            <div className="flex flex-wrap gap-3">
                                ...
                                <select
                                    ...
                                    className="border border-gray-300 dark:border-gray-700 rounded-lg text-sm px-3 py-2 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 min-w-[180px]"
                                >
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                                <thead className="bg-gray-50 dark:bg-gray-950">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Movement Type</th>
                                    ...
                                    {movements.data?.length === 0 && (
                                        <tr>
                                            <td colSpan="6" className="px-6 py-16 text-center text-gray-500 dark:text-gray-400">
                                                ...
                                                <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">No stock movement yet.</p>
                                        ...
                                        return (
                                            <tr key={m.id} className="hover:bg-gray-50 dark:bg-gray-950">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <Link href={adminUrl(`/admin/inventory/product/${m.product?.id}`)} className="text-sm font-medium text-gray-900 dark:text-gray-100 hover:text-blue-600">
                                                        {m.product?.name ?? 'Deleted Product'}
                                                    </Link>
                                                    {m.product?.sku && <div className="text-xs text-gray-400 dark:text-gray-500">{m.product.sku}</div>}
                                                    {m.variant && <div className="text-xs text-gray-400 dark:text-gray-500">Variant: {m.variant.sku}</div>}
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
