                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-900">{adjustment.adjustment_number || `Adjustment #${adjustment.id}`}</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            ...
                            {adjustment.product ? (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <Link href={adminUrl(`/admin/inventory/product/${adjustment.product.id}`)} className="text-sm font-semibold text-gray-900 hover:text-blue-600">
                                            {adjustment.product.name}
                                        </Link>
                                        <div className="text-xs text-gray-400 font-mono">{adjustment.product.sku || 'No SKU'}</div>
                                        {adjustment.variant && (
                                            <div className="text-xs text-gray-400">Variant: {adjustment.variant.sku}</div>
                                        )}
                                    </div>
                                </div>
                            ) : (
                                <p className="text-sm text-gray-400">Deleted Product</p>
                            )}
                        </div>

                        {/* Location */}
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            <h2 className="text-sm font-semibold text-gray-900 mb-4">Inventory Location</h2>
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-lg bg-green-50 flex items-center justify-center">
                                    <Building2 className="w-5 h-5 text-green-600" />
                                </div>
                                <div>
                                    <div className="text-sm font-semibold text-gray-900">{adjustment.warehouse?.name || 'Primary Store'}</div>
                                    {adjustment.warehouse?.code && (
                                        <div className="text-xs text-gray-400 font-mono">{adjustment.warehouse.code}</div>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6 lg:col-span-2">
                            <h2 className="text-sm font-semibold text-gray-900 mb-4">Stock Change</h2>
                            <div className="grid grid-cols-3 gap-6 text-center">
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <div className="text-xs text-gray-500 mb-1">Before</div>
                                    <div className="text-3xl font-bold text-gray-900">{adjustment.before_stock}</div>
                                </div>
                                <div className="bg-gray-50 rounded-lg p-4">
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div className="text-3xl font-bold text-gray-900">{adjustment.after_stock}</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm font-medium text-gray-900">{adjustment.reason_label}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm font-medium text-gray-900">{adjustment.user || 'System'}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm font-medium text-gray-900">{new Date(adjustment.created_at).toLocaleString()}</div>
                                    </div>
                                </div>
                                ...
                                {adjustment.notes && (
                                    <div className="flex items-start gap-3 sm:col-span-2">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-700">{adjustment.notes}</div>
                                        </div>
                                    </div>
                                )}
                            </div>
