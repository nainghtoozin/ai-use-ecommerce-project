                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4 mb-4">
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        {(search || cityFilter || status) && (
                            <button onClick={() => { setSearch(''); setCityFilter(''); setStatus(''); router.get(adminUrl('/admin/townships'), {}, { preserveState: true }); }} className="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-gray-200 text-sm">Clear</button>
                        )}
                    </div>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                            {!townships?.data?.length ? (
                                <tr><td colSpan="5" className="px-6 py-12 text-center text-gray-500 dark:text-gray-400">No townships found.</td></tr>
