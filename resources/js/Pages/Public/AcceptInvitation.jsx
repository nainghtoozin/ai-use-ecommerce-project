...
export default function AcceptInvitation() {
    ...
    return (
        <GuestLayout>
            ...
            {existing_account ? (
                /* CASE 2: Existing Account — Password Only */
                        ...
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                <p className="text-sm text-blue-700">
                                    This email already has an account. Please enter your current password to join this store.
                                </p>
                            </div>
                        </div>
                    </div>
