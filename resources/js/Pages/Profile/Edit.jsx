        ...
        <ShopLayout>
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Update your name and email address.</p>
                ...
                {/* Profile Photo */}
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Profile Photo</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Update your profile photo.</p>

                    <div className="flex items-center gap-6">
                        <div className="shrink-0">
                            {avatarPreview ? (
                                <img src={avatarPreview} alt="Preview" className="w-20 h-20 rounded-full object-cover ring-2 ring-gray-200 dark:ring-gray-700" />
                            ) : auth.user.profile_image_url ? (
                                <img src={auth.user.profile_image_url} alt="Avatar" className="w-20 h-20 rounded-full object-cover ring-2 ring-gray-200 dark:ring-gray-700" />
                            ) : (
                                <div className="w-20 h-20 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-500 ring-2 ring-gray-200 dark:ring-gray-700">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">JPEG, PNG, GIF, or WebP. Max 2MB.</p>
                        </div>
                    </div>
                </div>
                ...
                {currentRole && (
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Role & Permissions</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Your current role and granted permissions.</p>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {currentPermissions.map((perm) => (
                                    <span key={perm} className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-50 dark:bg-gray-950 text-gray-600 dark:text-gray-400 ring-1 ring-inset ring-gray-500/20">
                                        {perm}
                                    </span>
                                ))}
                            </div>
                ...
                {/* Update Password */}
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Update Password</h2>
                    ...
                    <form onSubmit={submitPassword}>
                        <div className="mb-4">
                            <label htmlFor="current_password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Current Password</label>
                            <input
                                id="current_password"
                                type="password"
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Choose which notifications you want to receive.</p>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg border border-red-200 p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Once your account is deleted, all of its resources and data will be permanently deleted.</p>
                    ...
                    {!showDeleteConfirm ? (
                        ...
                        <form onSubmit={submitDelete}>
                            <div className="mb-4">
                                <label htmlFor="delete_password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Password</label>
                                <input
                                    id="delete_password"
                                    type="password"
                                    value={deleteForm.data.password}
                                    onChange={(e) => deleteForm.setData('password', e.target.value)}
                                    className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500"
                                    autoComplete="current-password"
                            ...
                            <div className="flex justify-end gap-3">
                                <button type="button" onClick={() => setShowDeleteConfirm(false)} className="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-gray-200 text-sm font-medium">
                                    Cancel
                                </button>
                                <button
                                    type="submit"
