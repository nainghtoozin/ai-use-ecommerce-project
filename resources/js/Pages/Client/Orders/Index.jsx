...
return (
        <ShopLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 sm:mb-8">My Orders</h1>
                            ...
                            >
                                ...
                                <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-800 flex gap-2 overflow-hidden">
                                    {order.items?.slice(0, 3).map((item) => (
                                        <div key={item.id} className="flex items-center gap-2 bg-gray-50 dark:bg-gray-950 px-3 py-1 rounded-full text-sm text-gray-700 dark:text-gray-300">
                                    ...
                                    {order.items?.length > 3 && (
                                        <span className="flex items-center text-sm text-gray-500 dark:text-gray-400">+{order.items.length - 3} more</span>
                                    )}
                                </div>
                            </Link>
                        ))}
