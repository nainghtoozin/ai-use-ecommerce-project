        ...
        <ShopLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="prose prose-gray max-w-none space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                        <p>By using our website and services, you agree to the following terms and conditions.</p>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Orders and Payments</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Shipping and Delivery</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Returns and Refunds</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Limitation of Liability</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Changes to Terms</h3>
