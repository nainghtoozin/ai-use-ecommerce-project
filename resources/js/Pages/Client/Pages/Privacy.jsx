            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="prose prose-gray max-w-none space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Information We Collect</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">How We Use Your Information</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Data Security</h3>
                        <p>We implement appropriate security measures to protect your personal information from unauthorized access, alteration, or disclosure.</p>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6">Contact</h3>
