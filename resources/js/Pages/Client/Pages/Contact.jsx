                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {(tel || tel2) && (
                            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">{tel}</p>
                                {tel2 && <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">{tel2}</p>}
                            </div>
                        )}
                        ...
                        {whatsapp && (
                            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">{whatsapp}</p>
                            </div>
                        )}
                        ...
                        {(email || support || sales) && (
                            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                                ...
                                {email && <p className="text-gray-600 dark:text-gray-400">{email}</p>}
                                {support && <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Support: {support}</p>}
                                {sales && <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Sales: {sales}</p>}
                            </div>
                        )}
                        ...
                        {telegram && (
                            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">@{telegram}</p>
                            </div>
                        )}

                        {addrStr && (
                            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 sm:col-span-2 lg:col-span-3">
                                <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="aspect-video">
                                {mapsLink.includes('embed') ? (
                                    ...
                                    <a
                                        ...
                                        className="flex items-center justify-center w-full h-full bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 transition-colors"
                                    >
