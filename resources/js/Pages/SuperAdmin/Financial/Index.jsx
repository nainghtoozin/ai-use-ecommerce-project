        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                    <p className="text-xl font-bold text-gray-900 dark:text-gray-100 truncate">{prefix}{value}</p>
...
function TransactionDetailDrawer({ txn, open, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex">
            ...
            <div className="relative ml-auto w-full max-w-xl bg-white dark:bg-gray-900 shadow-2xl overflow-y-auto" role="dialog" aria-modal="true" aria-label="Transaction details">
                <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-6 py-4 flex items-center justify-between z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Transaction Details</h2>
                            <p className="text-xs text-gray-500 dark:text-gray-400 font-mono">{txn.transaction_number}</p>
                        </div>
                    </div>
                ...
                <div className="p-6 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-gray-400 dark:text-gray-500">{formatDateTime(txn.created_at)}</span>
                    </div>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                            <div className="px-5 py-3 border-b border-gray-100 dark:border-gray-800">
                                <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                    <Building2 className="w-4 h-4 text-gray-400 dark:text-gray-500" /> Merchant
                                </h3>
                            </div>
                            <div className="p-5 space-y-2.5 text-sm">
                                <div className="flex justify-between">
                                    <span className="text-gray-500 dark:text-gray-400">Store</span>
                                    <span className="font-semibold text-gray-900 dark:text-gray-100">{txn.tenant.name}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-500 dark:text-gray-400">Email</span>
                                    <span className="text-gray-600 dark:text-gray-400">{txn.tenant.email || '—'}</span>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="bg-gray-50 dark:bg-gray-950 rounded-xl p-5 space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="font-semibold text-gray-900 dark:text-gray-100">{txn.plan?.name || '—'}</span>
                        </div>
                        {intent?.billing_cycle && (
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500 dark:text-gray-400">Billing Cycle</span>
                                <span className="capitalize text-gray-900 dark:text-gray-100">{intent.billing_cycle}</span>
                            </div>
                        )}
                        <div className="flex justify-between text-sm">
                            <span className="text-gray-500 dark:text-gray-400">Amount</span>
                            <span className="font-bold text-gray-900 dark:text-gray-100">{fmt(txn.amount, txn.currency)}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-gray-500 dark:text-gray-400">Currency</span>
                            <span className="text-gray-900 dark:text-gray-100">{txn.currency}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-gray-500 dark:text-gray-400">Gateway</span>
                            <span className="capitalize text-gray-900 dark:text-gray-100">{txn.gateway}</span>
                        </div>
                        {txn.gateway_reference && (
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500 dark:text-gray-400">Gateway Ref</span>
                                <span className="font-mono text-xs text-gray-600 dark:text-gray-400">{txn.gateway_reference}</span>
                            </div>
                        )}
                        {intent?.reference_number && (
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500 dark:text-gray-400">Intent Ref</span>
                                <span className="font-mono text-xs text-gray-600 dark:text-gray-400">{intent.reference_number}</span>
                            </div>
                        )}
                    </div>
                    ...
                    {intent?.evidences && intent.evidences.length > 0 && (
                        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                            <div className="px-5 py-3 border-b border-gray-100 dark:border-gray-800">
                                <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                    <Image className="w-4 h-4 text-gray-400 dark:text-gray-500" /> Evidence
                                </h3>
                            </div>
                            <div className="p-5 space-y-3">
                                {intent.evidences.map((ev) => (
                                    <div key={ev.id}>
                                        <div className="rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800">
                                            <img
                                ...
                                {intent.comments.map((c) => (
                                    <div key={c.id} className="flex items-start gap-3">
                                        <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center flex-shrink-0">
                                            <span className="text-xs font-semibold text-gray-600 dark:text-gray-400">{c.author_name?.charAt(0)?.toUpperCase() || '?'}</span>
                                        </div>
                    ...
                    {intent?.reviews && intent.reviews.length > 0 && (
                        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                            <div className="px-5 py-3 border-b border-gray-100 dark:border-gray-800">
                                <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                    <ShieldCheck className="w-4 h-4 text-gray-400 dark:text-gray-500" /> Audit Trail
                                </h3>
                            </div>
                            <div className="p-5 space-y-3">
                                {intent.reviews.map((r) => (
                                    <div key={r.id} className="flex items-start gap-3 text-sm">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-gray-100 capitalize">{r.action}</span>
                                                <span className="text-xs text-gray-400 dark:text-gray-500">{formatDateTime(r.created_at)}</span>
                                            </div>
                                            {r.reviewer_name && <p className="text-xs text-gray-500 dark:text-gray-400">by {r.reviewer_name}</p>}
                                            {r.reason && <p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Reason: {r.reason}</p>}
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    {txn.ledger && txn.ledger.length > 0 && (
                        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                            <div className="px-5 py-3 border-b border-gray-100 dark:border-gray-800">
                                <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                    <BookOpen className="w-4 h-4 text-gray-400 dark:text-gray-500" /> Ledger Entries
                                </h3>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="bg-gray-50 dark:bg-gray-950 text-left text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                        ...
                                        {txn.ledger.map((le) => (
                                            <tr key={le.id}>
                                                <td className="px-5 py-3">
                                                    <span className="capitalize text-gray-900 dark:text-gray-100">{le.type}</span>
                                                    {le.description && <p className="text-xs text-gray-500 dark:text-gray-400">{le.description}</p>}
                                                </td>
                                                <td className="px-5 py-3 font-mono font-semibold text-gray-900 dark:text-gray-100">
                                                    {fmt(le.amount, le.currency)}
                                                </td>
                                                <td className="px-5 py-3 text-gray-500 dark:text-gray-400">{formatDateTime(le.recorded_at)}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
        ...
        <AdminLayout>
            ...
            <div className="p-6 lg:p-8 space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Financial Console</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Platform transaction and financial overview</p>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                    ...
                    {showFilters && (
                        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950/50">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Amount Min</label>
                                ...
                                <div>
                                    <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Amount Max</label>
                    ...
                    {items.length > 0 ? (
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                                <thead className="bg-gray-50 dark:bg-gray-950">
                                    <tr>
                                        ...
                                        <th className="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Merchant</th>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {items.map((txn) => (
                                        <tr key={txn.id} className="hover:bg-gray-50 dark:bg-gray-950/50 transition-colors">
                                            <td className="px-5 py-4 whitespace-nowrap">
                                                <span className="text-sm font-mono font-semibold text-gray-900 dark:text-gray-100">{txn.transaction_number}</span>
                                            </td>
                                            <td className="px-5 py-4 whitespace-nowrap">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{txn.tenant?.name || '—'}</p>
                                                        <p className="text-xs text-gray-400 dark:text-gray-500">{txn.tenant?.email || ''}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{txn.plan?.name || '—'}</td>
                                            <td className="px-5 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 dark:text-gray-100">{fmt(txn.amount, txn.currency)}</td>
                                            <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{formatDate(txn.created_at)}</td>
                        ...
                        <div className="p-12 text-center">
                            ...
                            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">No Financial Records Yet</h3>
