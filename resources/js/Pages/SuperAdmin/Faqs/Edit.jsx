...
export default function FaqEdit({ faq, categories }) {
    const [form, setForm] = useState({
        ...
        question_my: faq.question_my || '',
        answer_en: faq.answer_en || '',
        answer_my: faq.answer_my || '',
    ...
    function handleSubmit(e) {
        e.preventDefault();
        setProcessing(true);
        router.put(`/superadmin/faqs/${faq.id}`, form, {
    ...
    return (
        <AdminLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Edit FAQ</h2>}>
            <Head title="Edit FAQ" />
            <div className="py-6">
                    ...
                    <div className="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Edit FAQ #{faq.id}</h3>
                                <Link href="/superadmin/faqs" className="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">Back to list</Link>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" value={form.question_en} onChange={(e) => setField('question_en', e.target.value)} className="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" />
                                ...
                                <div>
                                    ...
                                    <input type="text" value={form.question_my} onChange={(e) => setField('question_my', e.target.value)} className="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" />
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
                                <Link href="/superadmin/faqs" className="px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">Cancel</Link>
