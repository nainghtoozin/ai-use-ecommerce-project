...
export default function CreateBillingPaymentMethod() {
    ...
    function handleSubmit(e) {
        ...
        router.post('/superadmin/billing-payment-methods', formData, {
            forceFormData: true,
    ...
    return (
        <AdminLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Create Billing Payment Method</h2>}>
            <Head title="Create Billing Payment Method" />
                    ...
                    <div className="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
                                ...
                                >
                                    {processing ? 'Creating...' : 'Create Billing Payment Method'}
                                </button>
                            </div>
                        </form>
                    </div>
