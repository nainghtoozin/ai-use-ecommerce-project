...
export default function BillingPaymentMethodsIndex({ paymentMethods, filters }) {
    ...
    return (
        <AdminLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Billing Payment Methods</h2>}>
                                            ...
                                            return (
                                                <tr key={pm.id} className={`hover:bg-gray-50 dark:bg-gray-950 ${isArchived ? 'opacity-60' : ''}`}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100">{pm.display_name}</div>
                                                        {pm.bank_name && (
                                                            <div className="text-sm text-gray-500 dark:text-gray-400">{pm.bank_name}</div>
                                                        )}
                                                    </td>
