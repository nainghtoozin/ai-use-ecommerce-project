            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {!cartItems?.length ? (
                    <div className="text-center py-12 sm:py-16 bg-white rounded-xl border border-gray-200">
                        ...
                        <p className="mt-2 text-gray-500">Browse products from {tenant.name} and add items to your cart.</p>
                        <Link
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 sticky top-24">
                                ...
                                <div className="mt-5 pt-4 border-t border-gray-200 space-y-3">
                                    ...
                                    {promoMessage && (
                                        <div className={`text-xs px-3 py-2 rounded-lg flex items-center gap-1.5 ${promoError ? 'bg-red-50 text-red-700 border border-red-200' : 'bg-emerald-50 text-emerald-700 border border-emerald-200'}`}>
