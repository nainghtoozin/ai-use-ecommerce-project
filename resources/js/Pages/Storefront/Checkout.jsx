            ...
            <ShopLayout>
                <div className="max-w-md mx-auto px-4 py-16 text-center">
                    <div className="bg-white rounded-xl border border-gray-200 p-8">
                        ...
                        <Link href={`/store/${tenant.slug}/cart`} className="block mt-3 text-sm text-gray-500 hover:text-gray-700">
                            &larr; Back to Cart
                        </Link>
                    </div>
                </div>
    ...
    return (
        <ShopLayout>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 sm:mb-8">Checkout - {tenant.name}</h1>
                                ...
                                {paymentMethods?.map((pm) => {
                                    ...
                                    return (
                                        <div key={pm.id} onClick={() => updateField('payment_method_id', pm.id)}
                                            className={`rounded-xl border-2 transition-all cursor-pointer select-none ${isSelected ? 'border-blue-500 bg-blue-50/50 shadow-sm' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
                                            <div className="p-4">
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-colors ${isSelected ? 'border-blue-500' : 'border-gray-300'}`}>
                                                                                ...
                                                                                <div className="flex items-center gap-2 mt-0.5">
                                                                                    ...
                                                                                    {pm.account_number && (
                                                                                        <button type="button" onClick={(e) => { e.stopPropagation(); copyToClipboard(pm.account_number, pm.id); }}
                                                                                            className={`inline-flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-md transition-colors ${copiedId === pm.id ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}>
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1 ml-5">
                                                            ...
                                                            <button type="button" onClick={() => copyToClipboard(localAppliedPromotion.code, 'promo')}
                                                                className={`text-xs font-medium px-1.5 py-0.5 rounded transition-colors ${copiedId === 'promo' ? 'text-green-700' : 'text-gray-400 hover:text-gray-600'}`}>
