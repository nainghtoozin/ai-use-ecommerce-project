    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-3">
            <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-[11px] text-gray-500 dark:text-gray-400 uppercase tracking-wide font-medium">{label}</p>
            </div>
        ...
        <ShopLayout>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
                    <h1 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100">My Account</h1>
                    <span className="text-xs text-gray-500 dark:text-gray-400">Member since {new Date(customer.member_since).toLocaleDateString()}</span>
                </div>

                <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4 mb-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                            <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate">{customer.name}</h2>
                            <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{customer.email}</p>
                        </div>
                    </div>
                </div>

                <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">Order Overview</h2>
                ...
                <div className="flex flex-wrap gap-2.5">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 text-sm font-medium transition-colors"
                    >
