            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your delivery addresses for faster checkout.</p>
                    </div>
                ...
                {showForm && (
                    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 mb-6">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-6">{editingId ? 'Edit Address' : 'Add New Address'}</h2>
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Label</label>
                                    <select value={data.label} onChange={(e) => setData('label', e.target.value)} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={data.phone} onChange={(e) => setData('phone', e.target.value)} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" value={data.first_name} onChange={(e) => setData('first_name', e.target.value)} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                                    {errors.first_name && <p className="text-red-500 text-xs mt-1">{errors.first_name}</p>}
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Last Name</label>
                                    <input type="text" value={data.last_name} onChange={(e) => setData('last_name', e.target.value)} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" required />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select value={data.city_id} onChange={(e) => handleCityChange(e.target.value)} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Township</label>
                                    <select value={data.township_id} onChange={(e) => handleTownshipChange(e.target.value)} disabled={!data.city_id} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-50 dark:bg-gray-950 disabled:text-gray-400 dark:text-gray-500 disabled:cursor-not-allowed" required>
                            ...
                            <div>
                                ...
                                <textarea value={data.address_line} onChange={(e) => setData('address_line', e.target.value)} rows={2} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none" required />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" value={data.postal_code} readOnly tabIndex={-1} className="w-full border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-base bg-gray-50 dark:bg-gray-950 text-gray-500 dark:text-gray-400 cursor-not-allowed focus:outline-none" placeholder="Auto-filled from township" />
                                </div>
                                <div className="flex items-end">
                                    <label className="flex items-center gap-2.5 py-3">
                                        <input type="checkbox" checked={data.is_default} onChange={(e) => setData('is_default', e.target.checked)} className="rounded border-gray-300 dark:border-gray-700 text-blue-600 focus:ring-blue-500 w-4 h-4" />
                                        <span className="text-base text-gray-700 dark:text-gray-300">Set as default address</span>
                                    </label>
                                </div>
                            </div>
                ...
                {addresses.length === 0 && !showForm ? (
                    <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
                        ...
                        <h3 className="mt-4 text-xl font-semibold text-gray-900 dark:text-gray-100">No addresses saved</h3>
                        <p className="mt-2 text-base text-gray-500 dark:text-gray-400">Add an address to make checkout faster.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {addresses.map((address) => (
                            <div key={address.id} className={`bg-white dark:bg-gray-900 rounded-2xl border p-5 relative shadow-sm hover:shadow-md transition-shadow ${address.is_default ? 'border-blue-300 ring-1 ring-blue-100' : 'border-gray-200 dark:border-gray-800'}`}>
                                ...
                                <p className="text-base font-semibold text-gray-900 dark:text-gray-100">{address.first_name} {address.last_name}</p>
                                <div className="mt-2 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    {address.postal_code && (
                                        <p className="flex items-start gap-2">
                                            <svg className="w-4 h-4 text-gray-400 dark:text-gray-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                ...
                                <div className="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100 dark:border-gray-800">
                                    ...
                                    {!address.is_default && (
                                        <button onClick={() => handleSetDefault(address.id)} className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-950 rounded-lg transition-colors ml-auto">
