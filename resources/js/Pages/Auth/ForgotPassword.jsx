...
export default function ForgotPassword({ status, store_slug }) {
    ...
    return (
        <PlatformGuestLayout>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Forgot your password? Enter your email and we'll send you a reset link.</p>
            ...
            <form onSubmit={submit}>
                <div>
                    ...
                    <input id="email" type="email" value={data.email} onChange={(e) => setData('email', e.target.value)}
                        className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required />
